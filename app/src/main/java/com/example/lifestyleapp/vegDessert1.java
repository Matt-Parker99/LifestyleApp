...
public class vegDessert1 extends AppCompatActivity {
    ...
    Double quantaties[] = {2.0,1.0,5.0,6.0,2.0,3.0,0.100,2.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_dessert1);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegDessert1.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/chocolate-peanut-butter-avocado-pudding"));
        startActivity(myIntent);
    }
