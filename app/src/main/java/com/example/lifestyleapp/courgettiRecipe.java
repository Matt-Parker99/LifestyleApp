...
public class courgettiRecipe extends AppCompatActivity {
    ...
    String ingredients[] = {"baby plum tomatoes 8, 4 halved and 4 whole",
"olive oil",
...
"pine nuts 1 tbsp, toasted",
    ...
    Double quantaties[] = {8.0,1.0,0.5,1.0,1.0,2.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_courgetti_recipe);
