...
public class veganBreakfast5 extends AppCompatActivity {
    ...
    Double quantaties[] = {0.075,0.025,4.0,0.250,2.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vegan_breakfast5);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(veganBreakfast5.this, "Accessing Recipe Website", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/cardamom-peach-quinoa-porridge"));
        startActivity(myIntent);
    }
