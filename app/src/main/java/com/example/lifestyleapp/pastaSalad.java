...
public class pastaSalad extends AppCompatActivity {
    ...
    String ingredients[] = {"short pasta", "vine tomatoes", "olive oil", "red wine vinegar ", "baby capers ", "bocconcini ", "basil ", "chives "};
    // quantity units to bo added in the ingredient object file on DB
    Double quantaties[] = {0.150,3.0,2.0,1.0,1.0,1.0,0.150,1.0,2.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pasta_salad);
