...
public class vegDessert2 extends AppCompatActivity {
    ...
    String ingredients[] = {"1 frozen banana"
            ,"cocoa powder"
    };
    // quantity units to bo added in the ingredient object file on DB
    Double quantaties[] = {1.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_dessert2);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegDessert2.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/vegan-chocolate-banana-ice-cream"));
        startActivity(myIntent);
    }
