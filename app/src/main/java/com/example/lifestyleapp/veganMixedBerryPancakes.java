...
public class veganMixedBerryPancakes extends AppCompatActivity {
    ...
    String ingredients[] = {"mixed frozen berries", "icing sugar","lemon juice","plain flour","caster sugar","baking powder","salt a pinch","vanilla extract","unsweetened almond milk","vegetable oil"
};
    // quantity units to bo added in the ingredient object file on DB
    Double quantaties[] = {0.200,0.1,0.150,0.2,0.2,0.150,0.5};
    @Override
