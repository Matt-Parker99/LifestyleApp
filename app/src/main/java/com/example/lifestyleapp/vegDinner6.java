...
public class vegDinner6 extends AppCompatActivity {
    ...
    Double quantaties[] = {3.0,1.0,1.0,2.0,3.0,1.0,0.400,0.400,0.250,0.5,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_dinner6);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegDinner6.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/bean-halloumi-stew"));
        startActivity(myIntent);
    }
