...
public class vegDinner5 extends AppCompatActivity {
    ...
    String ingredients[] = {"shortcrust pastry"
            ,"plain flour"
            ,"mature cheddar"
            ,"asparagus spears"
            ,"frozen peas"
    ...
    Double quantaties[] = {0.500,1.0,0.025,0.200,0.100,2.0,0.100,0.150,1.0,0.100,0.300};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_dinner5);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegDinner5.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/double-cheese-spring-vegetable-tart"));
        startActivity(myIntent);
    }
