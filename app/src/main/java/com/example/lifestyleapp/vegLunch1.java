...
public class vegLunch1 extends AppCompatActivity {
    ...
    String ingredients[] = {"3 medium sweet potatoes"
            ,"smoked paprika"
            ," olive oil"
            ,"avocado"
            ,"lime"
    ...
    Double quantaties[] = {3.0,1.0,3.0,1.0,0.5,2.0,4.0,1.0,0.5};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_lunch1);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegLunch1.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/sweet-potato-peanut-butter-chilli-quesadillas"));
        startActivity(myIntent);
    }
