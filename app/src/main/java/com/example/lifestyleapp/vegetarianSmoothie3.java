...
public class vegetarianSmoothie3 extends AppCompatActivity {
    ...
    String ingredients[] = {"160g ripe strawberries","160g baby spinach","1 small avocado","150ml pot bio yogurt","2 small oranges","plus ½ tsp finely grated zest"};
    // quantity units to bo added in the ingredient object file on DB
    Double quantaties[] = {0.160, 0.160 , 1.0, 0.150,2.0,0.50};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vegetarian_smoothie3);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegetarianSmoothie3.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
