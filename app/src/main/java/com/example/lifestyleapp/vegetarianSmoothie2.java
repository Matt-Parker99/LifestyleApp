...
public class vegetarianSmoothie2 extends AppCompatActivity {
    ...
    String ingredients[] = {"1 banana","1 tbsp porridge oats","80g soft fruit ","150ml milk","1 tsp honey","1 tsp vanilla extract"};
    // quantity units to bo added in the ingredient object file on DB
    Double quantaties[] = {1.0, 1.0 , 0.80, 0.150,1.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vegetarian_smoothie2);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegetarianSmoothie2.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/two-minute-breakfast-smoothie"));
        startActivity(myIntent);
    }
