...
public class vegetarianSmoothie5 extends AppCompatActivity {
    ...
    Double quantaties[] = {2.0,0.150,0.150,2.0,0.5,0.100};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vegetarian_smoothie5);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegetarianSmoothie5.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/raspberry-and-apple-smoothie"));
        startActivity(myIntent);
    }
