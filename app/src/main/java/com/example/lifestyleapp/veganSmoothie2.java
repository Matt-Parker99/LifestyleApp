...
public class veganSmoothie2 extends AppCompatActivity {
    ...
    String ingredients[] = {"3 peeled kiwi fruit\n" +
            "\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vegan_smoothie2);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(veganSmoothie2.this, "Accessing Recipe Website", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/kiwi-fruit-smoothie"));
        startActivity(myIntent);
    }
