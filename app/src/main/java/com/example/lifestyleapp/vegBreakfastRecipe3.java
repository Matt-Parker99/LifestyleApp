...
public class vegBreakfastRecipe3 extends AppCompatActivity {
    ...
    String ingredients[] = {"2 small carrots"
            ,"180g porridge oats"
            ,"1 tsp cinnamon"
    ...
    Double quantaties[] = {2.0,0.180,1.0,1.0,0.075,0.850,1.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_breakfast_recipe3);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegBreakfastRecipe3.this, "Accessing Recipe Website", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/carrot-cake-porridge"));
        startActivity(myIntent);
    }
