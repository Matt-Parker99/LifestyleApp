...
public class vegDessert4 extends AppCompatActivity {
    ...
    String ingredients[] = {"unsalted butter"
            ,"golden caster sugar"
            ,"medium eggs"
            ,"vanilla extract"
            ,"self-raising flour"
    ...
    Double quantaties[] = {0.225,0.225,4.0,1.0,0.225,0.150,1.0,4.0,0.150,0.175,0.5,1.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_dessert4);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegDessert4.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/rosewater-raspberry-sponge-cake"));
        startActivity(myIntent);
    }
