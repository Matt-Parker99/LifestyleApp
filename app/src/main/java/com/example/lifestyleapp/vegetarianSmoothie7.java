...
public class vegetarianSmoothie7 extends AppCompatActivity {
    ...
    String ingredients[] = {"2 handfuls kale","½ avocado","½ lime","large handful frozen pineapple chunks","medium-sized chunk ginger","1 tbsp cashew nuts","1 banana"};
    // quantity units to bo added in the ingredient object file on DB
    Double quantaties[] = {2.0,0.5,0.5,6.0,1.0,0.1,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vegetarian_smoothie7);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegetarianSmoothie7.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/kale-smoothie"));
        startActivity(myIntent);
    }
