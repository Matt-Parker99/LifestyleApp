...
public class vegDessert5 extends AppCompatActivity {
    ...
    String ingredients[] = {"instant coffee"
            ,"coffee liqueur"
            ,"tub mascarpone"
            ,"condensed milk"
            ,"vanilla extract"
    ...
    Double quantaties[] = {3.0,3.0,0.250,0.085,1.0,6.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_dessert5);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegDessert5.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/quick-easy-tiramisu"));
        startActivity(myIntent);
    }
