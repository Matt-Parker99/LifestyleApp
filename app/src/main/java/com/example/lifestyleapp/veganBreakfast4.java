...
public class veganBreakfast4 extends AppCompatActivity {
    ...
    Double quantaties[] = {0.500,1.0,2.0,0.100,0.150,0.130,1.0,1.0,1.0,2.0,6.0,1.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vegan_breakfast4);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(veganBreakfast4.this, "Accessing Recipe Website", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/chive-waffles-maple-soy-mushrooms"));
        startActivity(myIntent);
    }
