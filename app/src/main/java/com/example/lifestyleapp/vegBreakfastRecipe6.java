...
public class vegBreakfastRecipe6 extends AppCompatActivity {
    ...
    String ingredients[] = {"oil"
            ...
            ,"cans of black  pinto beans"
            ," eggs"

            ," coriander"};
    // quantity units to bo added in the ingredient object file on DB
    Double quantaties[] = {2.0,1.0,1.0,3.0,2.0,1.0,0.400,2.0,6.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_breakfast_recipe6);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegBreakfastRecipe6.this, "Accessing Recipe Website", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/smoky-beans-baked-eggs"));
        startActivity(myIntent);
    }
