...
public class vegDinner1 extends AppCompatActivity {
    ...
    Double quantaties[] = {4.0,0.50,0.200,1.0,0.500,0.200,1.0,4.0,0.050,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_dinner1);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegDinner1.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/sweet-potato-harissa-cakes-poached-eggs"));
        startActivity(myIntent);
    }
