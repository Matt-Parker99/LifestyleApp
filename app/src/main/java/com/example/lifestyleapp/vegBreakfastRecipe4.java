...
public class vegBreakfastRecipe4 extends AppCompatActivity {
    ...
    String ingredients[] = {"2 slices of white bread"
            ,"knob of butter"
            ,"25g cheddar"
    ...
    Double quantaties[] = {2.0,1.0,0.025,1.0,1.0,1.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_breakfast_recipe4);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegBreakfastRecipe4.this, "Accessing Recipe Website", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/fried-egg-florentine-toastie"));
        startActivity(myIntent);
    }
