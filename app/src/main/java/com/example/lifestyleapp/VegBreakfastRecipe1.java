...
public class VegBreakfastRecipe1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_veg_breakfast_recipe1);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(VegBreakfastRecipe1.this, "Accessing Recipe Website", Toast.LENGTH_SHORT).show();
