...
public class vegDinner4 extends AppCompatActivity {
    ...
    String ingredients[] = {"rapeseed oil"
            ...
            ,"vegetarian buffalo mozzarella"};
    // quantity units to bo added in the ingredient object file on DB
    Double quantaties[] = {1.0,2.0,2.0,2.0,2.0,1.0,1.0,0.400,2.0,2.0,0.015,1.0,1.0,6.0,0.125};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_dinner4);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegDinner4.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/slow-cooker-vegetable-lasagne"));
        startActivity(myIntent);
    }
