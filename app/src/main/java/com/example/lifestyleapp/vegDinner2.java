...
public class vegDinner2 extends AppCompatActivity {
    ...
    String ingredients[] = {"wholegrain rice"
            ,"soy sauce"
            ,"mirin"
            ,"ginger"
            ,"honey"
    ...
    Double quantaties[] = {0.150,0.50,2.0,0.5,1.0,0.350,1.0,2.0,0.5,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_dinner2);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegDinner2.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/charred-spring-onions-teriyaki-tofu"));
        startActivity(myIntent);
    }
