...
public class vegBreakfastRecipe5 extends AppCompatActivity {
    ...
    Double quantaties[] = {3.0,0.50,6.0,0.250,1.0,0.040,2.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_breakfast_recipe5);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegBreakfastRecipe5.this, "Accessing Recipe Website", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/eggy-cheese-crumpets"));
        startActivity(myIntent);
    }
