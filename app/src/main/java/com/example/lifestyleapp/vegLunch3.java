...
public class vegLunch3 extends AppCompatActivity {
    ...
    Double quantaties[] = {1.0,1.0,1.0,1.0,2.0,2.0,1.0};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veg_lunch3);
...
//    };
    ...
    public void viewRecipeOnline(android.view.View view){
        Toast.makeText(vegLunch3.this, "Accessing Website Of Recipe", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.bbcgoodfood.com/recipes/sweet-potato-hash-eggs-smashed-avo"));
        startActivity(myIntent);
    }
